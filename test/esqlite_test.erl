...
sqlite_version_test() ->
    ...
    ?assertEqual({row, {<<"3.23.2">>}}, esqlite3:step(Stmt)),
    ok.
...
sqlite_source_id_test() ->
    ...
    ?assertEqual({row, {<<"2018-05-09 02:23:29 f139f6f07df094a0a62e0a55ae7e91dc68006d55c9db7b244a945cc8216f55ff">>}}, esqlite3:step(Stmt)),
    ok.
